...
public class TaskFirst {
	public static void main(String[] args) {
		...
		System.out.println("¬ведите количество строк дл€ заданной матрицы>> ");
		...
		while (linesCount <= 0) {
			System.out.println("¬ведите число больше 0>> ");
			linesCount = scan.nextInt();
		}

		System.out.println("¬ведите количество столбцов дл€ заданной матрицы>> ");
